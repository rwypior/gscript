#ifndef _h_script_value
#define _h_script_value
...
/*
#define SV_OP_STATIC(typeA, typeB, returnType, op) inline returnType operator op(const typeA &a, const typeB &b) { return returnType(a.val op b.val); };

#define SV_OP_STATIC_ALLOP(typeA, typeB, returnType) \
	SV_OP_STATIC(typeA, typeB, returnType, +) \
	SV_OP_STATIC(typeA, typeB, returnType, -) \
	SV_OP_STATIC(typeA, typeB, returnType, *) \
	SV_OP_STATIC(typeA, typeB, returnType, /)

#define SV_OP_STATIC_ALLOP_B(typeA, typeB) SV_OP_STATIC_ALLOP(typeA, typeB, typeB)

#define SV_OP_TPL(KW_VIRTUAL, KW_0) \
	KW_VIRTUAL ScriptValue *operator +		(const ScriptBoolValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptBoolValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptBoolValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptBoolValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptBoolValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptBoolValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptCharValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptCharValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptCharValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptCharValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptCharValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptCharValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptByteValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptByteValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptByteValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptByteValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptByteValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptByteValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptIntValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptIntValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptUnsignedIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptUnsignedIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptUnsignedIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptUnsignedIntValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptUnsignedIntValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptUnsignedIntValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptFloatValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptFloatValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptFloatValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptFloatValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptFloatValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptFloatValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptDoubleValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptDoubleValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptDoubleValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptDoubleValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptDoubleValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptDoubleValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptStringValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptStringValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptStringValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptStringValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptStringValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptStringValue &b) const KW_0; \
\
	KW_VIRTUAL ScriptValue *operator +		(const ScriptClassValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator +=		(const ScriptClassValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -		(const ScriptClassValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator -=		(const ScriptClassValue &b) const KW_0; \
	KW_VIRTUAL ScriptValue *operator ==		(const ScriptClassValue &b) const KW_0; \
	...
	KW_VIRTUAL ScriptValue *operator <		(const ScriptClassValue &b) const KW_0;	\
\
	KW_VIRTUAL ScriptValue *operator !		() const KW_0; \
	KW_VIRTUAL ScriptValue *operator ++		() const KW_0; \
	KW_VIRTUAL ScriptValue *operator --		() const KW_0;

#define SV_OP_DECL_DECL() SV_OP_TPL(virtual, =0)

#define SV_OP_DECL_OVERRIDE() SV_OP_TPL(NOARG, override)
*/
