...
TEST_CASE_METHOD(GscriptTest, "RuntimeFor")
{
	...
	auto opincrement = std::make_unique<gscript::ScriptOperatorIncrement>(globalNamespace, gscript::OperatorLinkage::Right);
	...
	auto mul = std::make_unique<gscript::ScriptOperatorAddTo>(globalNamespace, gscript::OperatorLinkage::Both);
